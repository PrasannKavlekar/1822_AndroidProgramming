...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbClient.open();
        dbClient.addUser("Prasann Kavlekar","7020168074","prasann@gmail.com","password","password");
...
//                bday.setText(u.bval);
                ...
                Cursor curs = dbClient.getData();
                if (curs.getCount()==0) {
                    Toast.makeText(MainActivity.this, "This is empty!", Toast.LENGTH_SHORT).show();
                }
                else {
                    while(curs.moveToNext()){
                        name.setText(curs.getString(0));
                        phone.setText(curs.getString(1));
                        email.setText(curs.getString(2));
                        password.setText(curs.getString(3));
                        cpassword.setText(curs.getString(4));
                        mtool.setTitle(curs.getString(0));
                    }
                }
            }
        });
